...
public class GenericDao<X> {
    ...
    public FacesMessage create(X x) {
        try {
            ...
            s.close();
            return new FacesMessage(FacesMessage.SEVERITY_INFO, "Saved successfully", "save student");
        } catch (HibernateException ex) {
            return new FacesMessage(FacesMessage.SEVERITY_ERROR, "failed to save student " + ex.getLocalizedMessage(), "save student");
        }
    }
